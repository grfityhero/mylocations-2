...
import { DELETE_CATEGORY_ITEM, RESET } from "../../Types/CategoriesTypes"
import "./modalDelete.scss"
import { Modal, ModalBody, ModalFooter } from "reactstrap"

const ModalDeleteAction = ({ showModalDelete, setshowModalDelete }) => {
        ...
        >
          <ModalBody>
            <div className="modal-text">
              Are you sure you want to delete {state.activeCategory} &nbsp; ?
            </div>
